  ...
  <div class="app-container">
    ...
    <el-form ref="queryForm" :inline="true" label-width="68px">
      ...
      >
        ...
        >
          <el-option
            v-for="g in groupPartnerOptions"
            :key="g.id"
    ...
    <el-card>
      <div slot="header">
        <span>Danh sách request gần đây</span>
      </div>
      <el-table
        v-loading="loading"
        :data="partnerList"
      ...
      >
        <el-table-column label="Request ID" align="left" prop="id">
        ...
        >
          <template slot-scope="scope">
            <el-button
              ...
              type="text"
              @click="handleUpdate(scope.row)"
              >{{ scope.row.parnerCode }}</el-button
            >
          </template>
        </el-table-column>
        <el-table-column label="End Point" prop="endPoint">
          <template slot-scope="scope">
            <span :style="styleRow">{{ scope.row.endPoint }}</span>
          </template>
        </el-table-column>
        <el-table-column label="Method" align="center" prop="verb" width="120">
          <template slot-scope="scope">
            <span :style="styleRow">{{ scope.row.verb }}</span>
          </template>
        </el-table-column>
        ...
        <el-table-column label="Response" width="100">
          <template slot-scope="scope">
            <el-button size="mini" @click="showResponse(scope.row)"
              >Response</el-button
            >
          </template>
        </el-table-column>
          ...
          <el-row>
            ...
            <el-col :span="24">
              <el-form-item label="URL" prop="endPoint" label-width="20%">
                <el-input v-model="form.endPoint" placeholder="URL" />
              </el-form-item>
            </el-col>
            <el-col :span="24">
            ...
            <el-col :span="24">
              <el-form-item label="Method" prop="method" label-width="20%">
                <el-input v-model="form.verb" placeholder="Method" />
              </el-form-item>
            </el-col>
            <el-col :span="24">
            ...
            <el-col :span="24">
              <el-form-item label="Accept" label-width="20%">
                <el-input v-model="form.header.Accept" placeholder="Accept" />
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <el-form-item label="Accept-Encoding" label-width="20%">
                <el-input
                  v-model="form.header['Accept-Encoding']"
            ...
            <el-col :span="24">
              <el-form-item label="Accept-Language" label-width="20%">
                <el-input
                  v-model="form.header['Accept-Language']"
            ...
            <el-col :span="24">
              <el-form-item label="Authorization" label-width="20%">
                <el-input
                  v-model="form.header.Authorization"
            ...
            <el-col :span="24">
              <el-form-item label="Connection" label-width="20%">
                <el-input
                  v-model="form.header.Connection"
            ...
            <el-col :span="24">
              <el-form-item label="Host" label-width="20%">
                <el-input v-model="form.header.Host" placeholder="Host" />
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <el-form-item label="Referer" label-width="20%">
                <el-input v-model="form.header.Referer" placeholder="Referer" />
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <el-form-item label="User-Agent" label-width="20%">
                <el-input
                  v-model="form.header['User-Agent']"
    ...
    <!-- Popup Response-->
    <el-dialog
      title="Thông tin response"
      :visible.sync="openResponse"
      width="1000px"
      append-to-body
      class="dialog-body"
    >
      <div class="field-box">
        <el-form ref="formResponse" :model="formResponse" label-width="80px">
          <el-row>
            <el-col :span="24">
              <el-divider content-position="left"
                ><h4>Thông tin chung</h4></el-divider
            ...
            <el-col :span="24">
              <el-form-item label="IP" prop="method" label-width="20%">
                <el-input v-model="formResponse.ip" placeholder="IP" />
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <el-form-item label="Parner Code" prop="type" label-width="20%">
                <el-input
                  v-model="formResponse.parnerCode"
          ...
          <el-row>
            <el-col :span="24" style="text-align: center">
              <el-button @click="cancelPopupResponse">Hủy</el-button>
            </el-col>
          </el-row>
          <br />
        </el-form>
...
<script>
import { listAllGroupPartner } from "@/api/partner/partner.js";
import {
  searchAndPagingLogRequest,
  GetRequestLoggingByRequestId,
} from "@/api/log/request.js";
import { ReportRequestOrExceptionByTime } from "@/api/log/exception.js";
import { GetResponseLoggingByRequestId } from "@/api/log/response.js";
...
export default {
  ...
  data() {
    return {
      ...
      open: false,
      form: { requestModel: "", header: "" },

      openResponse: false,
      formResponse: { requestModel: "", header: "" },
    };
  },
  created() {
    this.genChart();
  ...
  methods: {
    ...
    getList() {
      ...
      searchAndPagingLogRequest(params).then((response) => {
    ...
    genChart() {
      //Request = 0
      ReportRequestOrExceptionByTime(0).then((response) => {
        response.result.forEach((value, index) => {
          this.chartLabel.push(value.time);
          this.chartBar.push(value.count);
        });
      });
      //Exception = 1
    ...
    handleUpdate(row) {
      ...
      GetRequestLoggingByRequestId(_requestId).then((response) => {
        ...
        this.form.header = JSON.parse(string);
        this.open = true;
      });
    },
    cancelPopupResponse() {
