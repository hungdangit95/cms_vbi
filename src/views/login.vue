<template>
  <div class="login">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
      <img src="https://vbi.vietinbank.vn/image/configure/1515559751_VietInbank_Insurance.png" />
    ...
    <div class="el-login-footer">
      <span>Copyright © 2020-2021 Vietinbank Insurance All Rights Reserved.</span>
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      cookiePassword: "",
      loginForm: {
        username: "danbx.vbi@vietinbank.vn",
        password: "Vbi@2018",
        rememberMe: false,
        uuid: ""
      },
